...
/** Element de acordeon accesibil pe <details>/<summary>, în stilul DentaLine. */
  ...
  return (
    <details className="group card-surface overflow-hidden transition hover:border-plum-200">
      <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-6 py-5 [&::-webkit-details-marker]:hidden">
        <span className="text-[16px] font-bold leading-snug text-plum-950">{question}</span>
        <span
      ...
      <div className="border-t border-plum-100 px-6 pb-6 pt-4 text-[15px] leading-relaxed text-plum-900/75">
        {children}
      </div>
    </details>
  )
