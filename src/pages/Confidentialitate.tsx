...
export default function Confidentialitate() {
  usePageMeta(
    'Politica de confidențialitate — DentaLine Clinic Galați',
    'Cum prelucrează DentaLine Clinic Galați datele tale personale: ce colectăm prin formularul de programare, în ce scop, temeiul legal și drepturile tale GDPR.',
  )
