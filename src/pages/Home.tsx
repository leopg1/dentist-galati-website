...
const whyCards = [
  ...
  },
  {
    ...
    text: 'Dr. Vasiliu, Dr. Șerban, Dr. Caraman și Dr. Sacara — fiecare cu propriile recenzii de 5 stele de la pacienții ei.',
...
function GoldStars() {
  return (
    <div className="flex gap-1" role="img" aria-label="Evaluare 5 din 5 stele">
    ...
    <>
              ...
              <Reveal key={service.slug} delay={(i % 3) * 0.08} className="h-full">
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-6 md:p-7">
                    <h3 className="h-display text-2xl">{service.title}</h3>
        ...
        <div className="container-site grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <Reveal className="relative mx-auto w-full max-w-md lg:max-w-none">
            <div className="aspect-[4/5] overflow-hidden rounded-3xl shadow-lift">
              <img
                src="/media/team/echipa-lila.jpg"
                alt="Echipa DentaLine — patru colege în uniforme lila, zâmbind în clinică"
                loading="lazy"
            ...
            <div className="card-surface absolute -bottom-6 -right-4 flex items-center gap-3.5 p-5 sm:-right-8">
              ...
              <div>
                ...
                <p className="text-[13px] font-medium text-plum-900/70">
      ...
      <section className="section-pad">
        <div className="container-site">
          ...
          />
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-6 md:mt-16">
            {whyCards.map((card, i) => (
              <Reveal key={card.title} delay={i * 0.06} className={card.span}>
                <article className="card-surface h-full p-7 transition duration-300 hover:-translate-y-1 hover:shadow-lift md:p-8">
                  <div
                    className={`grid h-12 w-12 place-items-center rounded-2xl ${card.iconClass}`}
                  >
                    <card.icon className="h-6 w-6" aria-hidden="true" />
                  </div>
                  <h3 className="h-display mt-5 text-2xl">{card.title}</h3>
        ...
        <div className="container-site">
          <Reveal>
            <div className="isolate relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-plum-900 via-plum-800 to-coral-800 shadow-lift">
              ...
              />
              <div
                className="pointer-events-none absolute -bottom-32 -right-20 h-80 w-80 rounded-full bg-coral-600/25 blur-3xl"
                aria-hidden="true"
              />
              <div className="relative grid gap-10 px-7 py-12 md:px-12 md:py-16 lg:grid-cols-[1.2fr_1fr] lg:items-center lg:gap-16 lg:px-16">
                <div>
                  ...
                  <h2 className="h-display mt-3 text-4xl !text-white md:text-5xl">
                  ...
                  <ul className="mt-7 space-y-3.5">
                    {[
                      ...
                      <li key={benefit} className="flex items-center gap-3 font-semibold text-white">
                        <span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-teal-400/25 text-teal-300">
                  ...
                  <p className="mt-5 text-sm text-white/60">(condiții în clinică)</p>
                </div>

                <div className="flex flex-col gap-6">
                  <div className="rounded-3xl border border-white/15 bg-white/10 p-6 backdrop-blur-sm md:p-7">
                    <div className="flex items-center gap-3.5">
                      <div className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-white/15 text-white">
                        <CreditCard className="h-5 w-5" aria-hidden="true" />
                      </div>
                      <p className="font-bold text-white">Plata în rate prin tbi bank</p>
                    </div>
                    <p className="mt-3.5 leading-relaxed text-white/75">
